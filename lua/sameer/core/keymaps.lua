...
keymap.set("c", "<CR>", "<CR>:set nonu<CR>", { desc = "Toggle line numbers on command line mode enter" })
keymap.set("c", "<ESC>", "<ESC>:set nonu<CR>", { desc = "Toggle line numbers on command line mode enter" })
